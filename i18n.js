...
function apply(){
 ...
 var p1n=document.querySelector('[data-platform=douyin] .name');if(p1n)p1n.textContent='抖音';var p1d=document.querySelector('[data-platform=douyin] .desc');if(p1d)p1d.textContent='中文口播文案';
 var p2n=document.querySelector('[data-platform=tiktok-jp] .name');if(p2n)p2n.textContent='TikTok 日区';var p2d=document.querySelector('[data-platform=tiktok-jp] .desc');if(p2d)p2d.textContent='日语口播+中文翻译';
 var p3n=document.querySelector('[data-platform=tiktok-us] .name');if(p3n)p3n.textContent='TikTok 美区';var p3d=document.querySelector('[data-platform=tiktok-us] .desc');if(p3d)p3d.textContent='英语口播+中文翻译';
